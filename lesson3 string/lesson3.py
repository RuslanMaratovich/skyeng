...
print('.rindex(\'п\')', st.rindex('п'))  # .rindex() - метот показывает под каким индексом в первый раз встречается буква п с конца строки

print('подстрока [8:19]', st[8:19]) #вести строку от 8 индекса включительно до 19 индекса не включая его

print('подстрока [8:-5]', st[8:-5]) #вести строку от 8 индекса включительно до -5 индекса -5 ститает индексы с конца строки

print('.lower()', st.lower()) #.lower() - метод переводит все символы строки в нижний регистр

print('.upper()', st.upper()) #.lower() - метод переводит все символы строки в верхний регистр
